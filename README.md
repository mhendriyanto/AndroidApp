...
Before presenting or evaluating the demo, complete this checklist:

- Test account creation, sign in, screenshot import, timers, archive, folders, restore, and Firebase persistence
- Verify the emulator has screenshots available for import
- Confirm Firebase Auth, Firestore, and Storage are connected
- Confirm the privacy policy screen is visible in Settings
- Record or rehearse the main two-minute demo workflow
